...
import com.rafael.paymentspringjpa.services.CategoryService;
...
@RestController
@RequestMapping(value = "/categories")//nome pro recurso - endpoint
public class CategoryController {

    //para a classe CategoryController faca a injecao automatica do CategoryService por meio do AutoWired, é necessário
    //registrar a classe CategoryService como Componente do Spring
    @Autowired
